...
description: Use when Grok Bot is working on a repo or task that is scoped to an OrgX initiative, workstream, milestone, task, blocker, or decision and needs to use OrgX MCP as the source of truth.
---
...
- Use `source_client=grok_bot` whenever the tool supports client attribution.
