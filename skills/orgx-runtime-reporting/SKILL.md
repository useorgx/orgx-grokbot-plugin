...
description: Use when a Grok Bot execution should report progress, artifacts, blockers, or completion state back to OrgX during a live task.
---

# OrgX Runtime Reporting

Use this skill when Grok Bot should keep OrgX updated during execution.
...
- **Stale-client fallback:** if bootstrap or docs advertise
  ...
  giving the report.
- **Passive backstop:** Grok Bot runtime hooks installed by `orgx-wizard hooks
